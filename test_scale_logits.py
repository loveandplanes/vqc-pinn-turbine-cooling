...
# Let's test the training of a simple VQC with Gumbel-Softmax to select one state out of 16
# We want it to converge to state 5.
...
for epoch in range(100):
    ...
    # Cost: distance to one-hot target at index 5
    # soft_onehot is (batch, 16)
